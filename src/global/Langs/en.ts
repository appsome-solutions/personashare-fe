const enTranslations = {
  en: {
    translation: {
      ...
      LOGIN_BUTTON: 'Login',
      LOGIN_TEXT_BETWEEN_BUTTON: 'Or log in using Google account',
      LOGIN_GOOGLE: 'Google',
      ...
      REGISTER_REGULATIONS: 'I have read and agree to',
      REGISTER_TOS_CONFIRM: 'our term of use',
      REGISTER_PRIVACY_POLICY: 'the privacy and cookies policy',
      REGISTER_AND: 'and',
      REGISTER_INFORMATIVE_CLAUSE: 'the informative clause',
      ...
      CREATION_STEP_1_PERSONA_TOP_TAB:
        'Persona is a set of any data connected with your person. You can create many personas to fit different situations in your business, hobby or private life!',
      CREATION_STEP_1_PERSONA_TAB_1_TITLE: 'Business Card XXI century',
      CREATION_STEP_1_PERSONA_TAB_1:
        'It is always up to date.\n' +
        'You can insert here not only contact details, but also\n' +
      ...
      CREATION_STEP_1_PERSONA_TAB_2:
        ...
        'code anywhere: during events, conferences, in b2b\n' +
        'relations. And also sign your articles, books, texts,\n' +
        'comments, photos and medias. Use your creativity and make your brand visible everywhere.',
      ...
      CREATION_STEP_1_PERSONA_TAB_4:
        'Spots are places where you can leave your persona. These can be events, webinars, coffee bars, offices or any place where people meet together. You can join as a spot participant, show your persona and send message to your viewers.',
      CREATION_STEP_1_PERSONA_TAB_5_TITLE: 'Recommendations network',
      CREATION_STEP_1_PERSONA_TAB_5:
        'Encourage your friends,\n' +
        'partners and clients to recommend you. You are linked with your recommendators. Whenever they share their persona you are visible there, too. Create you own recommendation net!',
      CREATION_STEP_1_PERSONA_NEXT_STEP: 'NEXT STEP',

      CREATION_STEP_2_HEADING: 'Edit your card',
      CREATION_STEP_2_INFO:
        'Your card is a brief summary of the content you want to share. It consists of a background image, an avatar, a name and a short description (eg. what or who you are looking for).',
      ...
      CREATION_STEP_3_INFO:
        'Your page is fully predefined set of data you want to share with others. You can edit it whenever you want to.',
      ...
      CREATION_STEP_1_SPOT_TAB_1:
        'It is always up to date. You can insert here not only contact details, but also links to surveys, your social media, groups, products, services, booking pages, blogs, tutorials, books, articles, actually... anything you want! Just take a look at our build-in editor!',
      ...
      CREATION_STEP_1_SPOT_TAB_3:
        'You can allow any persona to be visible on your spot. It will help integrate people and give them a possibility to share brief message with others.',
      CREATION_STEP_1_SPOT_TAB_4_TITLE: 'Make your brand visible',
      CREATION_STEP_1_SPOT_TAB_4:
        'By using qr codes you can encourage others to see your spot details. With that you can show them your services and products, redirect them to social medias and give them access to anything they should know. It all depends on your imagination!',
      CREATION_STEP_1_SPOT_TAB_5_TITLE: 'Recommendations network',
      CREATION_STEP_1_SPOT_TAB_5:
        'Get a recommendation from your friends, partners and clients. You are linked with your recommendators. Whenever they share their persona you are visible there, too. Create you own recommendation net!',
      CREATION_STEP_1_SPOT_LIMITATIONS_TAB:
        'You can use spots totally free, but there are some limitations: 1. You can add max 3 managers, 2. To participant list can join max 20 people, 3.Your spot can be recommended by up to 5 people. If you would like to create a bigger spot, please contact us - we will gladly talk about cooperation!',
      ...
      CREATION_STEP_2_SPOT_INFO:
        'A spot card is a brief description of your dataset for a given spot. Includes an avatar, a background image, a name and a short message. You can write anything you like in it: briefly describe the spot, write what the spot is about, ask about something, announce something, etc.',
